...
func (s *PDSTestSuite) TestEventReporting_Successful() {
...
func (s *PDSTestSuite) TestEventReporting_Update_Deployment_Successful() {
	// Create a new deployment.
	deployment := api.ShortDeploymentSpec{
		DataServiceName: dataservices.Postgres,
		ImageVersionTag: PostgreSQLImageTag,
...
func (s *PDSTestSuite) TestEventReporting_Delete_Deployment_NoEvents() {
	deployment := api.ShortDeploymentSpec{
		DataServiceName: dataservices.Postgres,
		ImageVersionTag: PostgreSQLImageTag,
		NodeCount:       1,
...
func (s *PDSTestSuite) TestEventReporting_Failed_Deployment_No_Duplicate_Events() {
	deployment := api.ShortDeploymentSpec{
