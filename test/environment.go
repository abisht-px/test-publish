...
const (
	...
	envDataServiceTLSEnabled    = "DATA_SERVICE_TLS_ENABLED"
)
...
func mustHaveEnvVariables(t *testing.T) environment {
	t.Helper()
	dataServiceTLSEnabled, err := strconv.ParseBool(os.Getenv(envDataServiceTLSEnabled))
	if err != nil {
		dataServiceTLSEnabled = false
	}
