...
var expectedDefaultCapabilities = pds.ModelsDeploymentTargetCapabilities{
	...
	Cassandra:      pointer.String("v1"),
	Consul:         pointer.String("v1"),
	Couchbase:      pointer.String("v1"),
	CrdReporting:   pointer.String("v2"),
	DataServiceTls: pointer.String(""),
	Database:       pointer.String("v1"),
	Elasticsearch:  pointer.String("v1"),
	Kafka:          pointer.String("v1"),
	Mongodb:        pointer.String("v1"),
	Mysql:          pointer.String("v1"),
	Postgresql:     pointer.String("v1"),
	Rabbitmq:       pointer.String("v1"),
	Redis:          pointer.String("v1"),
	Restore:        pointer.String(""),
	Sqlserver:      pointer.String("v1"),
	Zookeeper:      pointer.String("v1"),
}
