...
// TODO(saheienko): find a way to add this as a dependency instead of making a copy.
// Upstream: https://github.com/helm/helm/blob/v2.17.0/pkg/kube/tunnel.go
// Copied this Tunnel implementation to reduce number of dependencies.
// Also, this file exists only for helm v2.
